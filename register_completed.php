  ...
  <body>       
    ...
    <nav class="navbar navbar-expand-md  navbar-dark bg-dark" style="background:#aaa">                                                                     
       ...
       <div class="dropdown-menu">
        <form class="px-4 py-3">
         <div class="form-group">
            ...
            <input type="text" class="form-control" id="nickname_dropdown" name="password_dropdown">
         </div>
           <div class="form-group">
      ...
      if(isset($_POST['submit_dropdown_login'])){
        ...
        echo $nickname_dropdown;
        ?>
        <script>
        var url="http://student.sspbrno.cz/~duron.zdenek/pcbazar/login_failed.php";
